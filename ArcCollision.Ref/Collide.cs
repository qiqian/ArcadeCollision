    ...
    public static partial class Collide
    {
        ...
        private readonly struct ConvexProxy
        {
                ...
                in ConvexProxy source, FxVec2 translation, Angle32 rotation)
            {
                ...
                Count = source.Count;
                Radius = source.Radius;
                Center = Transform(source.Center, _axisX, _axisY) + translation;
            }
            ...
            public FxVec2 Vertex(int index)
            {
                if (_vertices != null)
                {
                    ...
                    return (_rotated ? Transform(value, _axisX, _axisY) : value) + _offset;
                }
                ...
                return (_rotated ? Transform(vertex, _axisX, _axisY) : vertex) + _offset;
            }
            ...
            // Static, and taking the basis explicitly, so the rotating constructor
            // can call it before every field is assigned; C# 9 forbids touching
            // `this` until then.
            private static FxVec2 Transform(FxVec2 vertex, FxAxis axisX, FxAxis axisY) =>
                axisX.Scale(vertex.X) + axisY.Scale(vertex.Y);
        }
